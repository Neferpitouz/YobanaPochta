...
class Main {
    ...
    public static class UntrustworthyMailWorker implements MailService{
        MailService[] mailers;
        UntrustworthyMailWorker (MailService[] mailers) {
        ...
        public Sendable processMail(Sendable mail) {
            if (mail instanceof MailMessage) {
                if (mail.getTo().contains(AUSTIN_POWERS) | mail.getFrom().contains(AUSTIN_POWERS)) {
                    logger.log(Level.WARNING, String.format("Detected target mail correspondence: from %s to %s \"%s\"", mail.getFrom(), mail.getTo(), ((MailMessage)mail).getMessage()));
                } else {
    ...
    public static class Thief implements MailService{
        private int costValue, summaryCost;
        Thief (int costValue) {
    ...
    public static void main(String[] args) {
        ...
        spy.processMail(new MailMessage(AUSTIN_POWERS, "Lennox", "Dabudabuda"));
